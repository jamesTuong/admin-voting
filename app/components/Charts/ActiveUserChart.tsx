...
const chartData = [
  ...
  { date: "2024-04-02", desktop: 10, mobile: 18 },
  ...
  { date: "2024-04-08", desktop: 41, mobile: 32 },
  ...
  { date: "2024-04-16", desktop: 14, mobile: 19 },
  ...
  { date: "2024-04-23", desktop: 14, mobile: 23 },
  ...
  { date: "2024-05-08", desktop: 15, mobile: 21 },
  ...
  { date: "2024-05-20", desktop: 18, mobile: 23 },
  ...
  { date: "2024-06-05", desktop: 9, mobile: 14 },
  ...
  { date: "2024-06-14", desktop: 43, mobile: 38 },
  ...
  { date: "2024-06-20", desktop: 41, mobile: 45 },
  ...
  { date: "2024-06-28", desktop: 15, mobile: 20 },
    ...
    <Card>
      <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
          <CardTitle>Số lượng truy cập ứng dụng - (theo ngày)</CardTitle>
          <CardDescription>
            Hiển thị tổng người dùng truy cập theo thời gian thực
          </CardDescription>
        </div>
        <div className="flex">
